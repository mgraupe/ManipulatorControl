...
#
# Created: Fri Jul 17 16:06:43 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_8 = QtGui.QGridLayout(self.gridFrame)
        self.gridLayout_8.setContentsMargins(9, 6, 6, 6)
        self.gridLayout_8.setObjectName(_fromUtf8("gridLayout_8"))
        self.label_13 = QtGui.QLabel(self.gridFrame)
        ...
        self.label_6 = QtGui.QLabel(self.horizontalWidget1)
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.horizontalLayout_13.addWidget(self.label_6)
        self.device1SpeedLE = QtGui.QLineEdit(self.horizontalWidget1)
        ...
        self.gridLayout_8.addWidget(self.horizontalWidget1, 13, 0, 1, 2)
        self.label_23 = QtGui.QLabel(self.gridFrame)
        ...
        self.horizontalLayout_12 = QtGui.QHBoxLayout(self.horizontalWidget2)
        self.horizontalLayout_12.setMargin(1)
        self.horizontalLayout_12.setObjectName(_fromUtf8("horizontalLayout_12"))
        self.xSetPosDev1LE = QtGui.QLineEdit(self.horizontalWidget2)
        ...
        self.ySetPosDev1LE = QtGui.QLineEdit(self.horizontalWidget2)
        ...
        self.zSetPosDev1LE = QtGui.QLineEdit(self.horizontalWidget2)
        ...
        self.gridLayout_8.addWidget(self.horizontalWidget2, 10, 1, 1, 1)
        self.label_9 = QtGui.QLabel(self.gridFrame)
        self.label_9.setObjectName(_fromUtf8("label_9"))
        self.gridLayout_8.addWidget(self.label_9, 2, 0, 1, 1)
        self.label_17 = QtGui.QLabel(self.gridFrame)
        ...
        self.horizontalWidget3 = QtGui.QWidget(self.gridFrame)
        ...
        self.label_18 = QtGui.QLabel(self.horizontalWidget4)
        ...
        self.gridLayout_8.addWidget(self.horizontalWidget4, 6, 0, 1, 3)
        ...
        self.fineBtn = QtGui.QPushButton(self.horizontalWidget5)
        ...
        self.smallBtn = QtGui.QPushButton(self.horizontalWidget5)
        ...
        self.mediumBtn = QtGui.QPushButton(self.horizontalWidget5)
        ...
        self.coarseBtn = QtGui.QPushButton(self.horizontalWidget5)
        ...
        self.gridLayout_8.addWidget(self.horizontalWidget5, 5, 0, 1, 3)
        self.horizontalWidget6 = QtGui.QWidget(self.gridFrame)
        self.horizontalWidget6.setObjectName(_fromUtf8("horizontalWidget6"))
        self.horizontalLayout_8 = QtGui.QHBoxLayout(self.horizontalWidget6)
        self.horizontalLayout_8.setMargin(1)
        self.horizontalLayout_8.setObjectName(_fromUtf8("horizontalLayout_8"))
        self.setXLocationLineEdit = QtGui.QLineEdit(self.horizontalWidget6)
        ...
        self.setYLocationLineEdit = QtGui.QLineEdit(self.horizontalWidget6)
        ...
        self.setZLocationLineEdit = QtGui.QLineEdit(self.horizontalWidget6)
        ...
        self.gridLayout_8.addWidget(self.horizontalWidget6, 4, 1, 1, 2)
        self.horizontalWidget7 = QtGui.QWidget(self.gridFrame)
        self.horizontalWidget7.setObjectName(_fromUtf8("horizontalWidget7"))
        self.horizontalLayout_9 = QtGui.QHBoxLayout(self.horizontalWidget7)
        self.horizontalLayout_9.setMargin(4)
        self.horizontalLayout_9.setObjectName(_fromUtf8("horizontalLayout_9"))
        self.isXLocationValueLabel = QtGui.QLabel(self.horizontalWidget7)
        ...
        self.isYLocationValueLabel = QtGui.QLabel(self.horizontalWidget7)
        ...
        self.isZLocationValueLabel = QtGui.QLabel(self.horizontalWidget7)
        ...
        self.gridLayout_8.addWidget(self.horizontalWidget7, 3, 1, 1, 2)
        self.horizontalWidget8 = QtGui.QWidget(self.gridFrame)
        self.horizontalWidget8.setObjectName(_fromUtf8("horizontalWidget8"))
        self.horizontalLayout_7 = QtGui.QHBoxLayout(self.horizontalWidget8)
        self.horizontalLayout_7.setMargin(4)
        self.horizontalLayout_7.setObjectName(_fromUtf8("horizontalLayout_7"))
        self.minMaxXLocationValueLabel = QtGui.QLabel(self.horizontalWidget8)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.minMaxYLocationValueLabel = QtGui.QLabel(self.horizontalWidget8)
        ...
        self.minMaxZLocationValueLabel = QtGui.QLabel(self.horizontalWidget8)
        ...
        self.gridLayout_8.addWidget(self.horizontalWidget8, 2, 1, 1, 2)
        self.controllerActivateBtn = QtGui.QPushButton(self.gridFrame)
        ...
        self.label_8 = QtGui.QLabel(self.gridFrame)
        ...
        self.horizontalWidget9 = QtGui.QWidget(self.gridFrame)
        self.horizontalWidget9.setObjectName(_fromUtf8("horizontalWidget9"))
        self.horizontalLayout_5 = QtGui.QHBoxLayout(self.horizontalWidget9)
        self.horizontalLayout_5.setMargin(1)
        self.horizontalLayout_5.setObjectName(_fromUtf8("horizontalLayout_5"))
        self.xSetPosDev2LE = QtGui.QLineEdit(self.horizontalWidget9)
        ...
        self.ySetPosDev2LE = QtGui.QLineEdit(self.horizontalWidget9)
        ...
        self.zSetPosDev2LE = QtGui.QLineEdit(self.horizontalWidget9)
        ...
        self.gridLayout_8.addWidget(self.horizontalWidget9, 10, 2, 1, 1)
        self.horizontalWidget10 = QtGui.QWidget(self.gridFrame)
        self.horizontalWidget10.setObjectName(_fromUtf8("horizontalWidget10"))
        self.horizontalLayout_10 = QtGui.QHBoxLayout(self.horizontalWidget10)
        self.horizontalLayout_10.setMargin(1)
        self.horizontalLayout_10.setObjectName(_fromUtf8("horizontalLayout_10"))
        self.device2StepLE = QtGui.QLineEdit(self.horizontalWidget10)
        ...
        self.label_12 = QtGui.QLabel(self.horizontalWidget10)
        self.label_12.setObjectName(_fromUtf8("label_12"))
        self.horizontalLayout_10.addWidget(self.label_12)
        self.device2SpeedLE = QtGui.QLineEdit(self.horizontalWidget10)
        ...
        self.gridLayout_8.addWidget(self.horizontalWidget10, 13, 2, 1, 1)
        self.horizontalWidget11 = QtGui.QWidget(self.gridFrame)
        self.horizontalWidget11.setObjectName(_fromUtf8("horizontalWidget11"))
        self.horizontalLayout_14 = QtGui.QHBoxLayout(self.horizontalWidget11)
        self.horizontalLayout_14.setSpacing(1)
        self.horizontalLayout_14.setMargin(1)
        self.horizontalLayout_14.setObjectName(_fromUtf8("horizontalLayout_14"))
        self.trackStageZMovementDev2Btn = QtGui.QPushButton(self.horizontalWidget11)
        ...
        self.trackStageXMovementDev2Btn = QtGui.QPushButton(self.horizontalWidget11)
        ...
        self.gridLayout_8.addWidget(self.horizontalWidget11, 14, 2, 1, 1)
        self.label_5 = QtGui.QLabel(self.gridFrame)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.gridLayout_8.addWidget(self.label_5, 14, 0, 1, 1)
        self.horizontalWidget12 = QtGui.QWidget(self.gridFrame)
        ...
        self.horizontalLayout_6 = QtGui.QHBoxLayout(self.horizontalWidget12)
        self.horizontalLayout_6.setMargin(1)
        self.horizontalLayout_6.setObjectName(_fromUtf8("horizontalLayout_6"))
        self.trackStageZMovementDev1Btn = QtGui.QPushButton(self.horizontalWidget12)
        ...
        self.trackStageXMovementDev1Btn = QtGui.QPushButton(self.horizontalWidget12)
        ...
        self.gridLayout_8.addWidget(self.horizontalWidget12, 14, 1, 1, 1)
        self.horizontalWidget13 = QtGui.QWidget(self.gridFrame)
        ...
        self.horizontalLayout_15 = QtGui.QHBoxLayout(self.horizontalWidget13)
        self.horizontalLayout_15.setMargin(1)
        self.horizontalLayout_15.setObjectName(_fromUtf8("horizontalLayout_15"))
        self.activateDev1 = QtGui.QPushButton(self.horizontalWidget13)
        ...
        self.activateDev2 = QtGui.QPushButton(self.horizontalWidget13)
        ...
        self.gridLayout_8.addWidget(self.horizontalWidget13, 7, 1, 1, 2)
        ...
        self.gridFrame1.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.gridFrame1.setFrameShape(QtGui.QFrame.StyledPanel)
        self.gridFrame1.setObjectName(_fromUtf8("gridFrame1"))
        self.gridLayout_2 = QtGui.QGridLayout(self.gridFrame1)
        self.gridLayout_2.setMargin(6)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.recordHomeLocationBtn = QtGui.QPushButton(self.gridFrame1)
        self.recordHomeLocationBtn.setObjectName(_fromUtf8("recordHomeLocationBtn"))
        self.gridLayout_2.addWidget(self.recordHomeLocationBtn, 1, 0, 1, 1)
        self.moveToHomeLocationBtn = QtGui.QPushButton(self.gridFrame1)
        self.moveToHomeLocationBtn.setObjectName(_fromUtf8("moveToHomeLocationBtn"))
        self.gridLayout_2.addWidget(self.moveToHomeLocationBtn, 5, 0, 1, 1)
        self.removeItemBtn = QtGui.QPushButton(self.gridFrame1)
        self.removeItemBtn.setMaximumSize(QtCore.QSize(16777215, 24))
        self.removeItemBtn.setObjectName(_fromUtf8("removeItemBtn"))
        self.gridLayout_2.addWidget(self.removeItemBtn, 12, 1, 1, 1)
        self.recordDepthBtn = QtGui.QPushButton(self.gridFrame1)
        self.recordDepthBtn.setMaximumSize(QtCore.QSize(16777215, 24))
        self.recordDepthBtn.setObjectName(_fromUtf8("recordDepthBtn"))
        self.gridLayout_2.addWidget(self.recordDepthBtn, 12, 0, 1, 1)
        self.moveToItemBtn = QtGui.QPushButton(self.gridFrame1)
        self.moveToItemBtn.setMaximumSize(QtCore.QSize(16777215, 24))
        self.moveToItemBtn.setObjectName(_fromUtf8("moveToItemBtn"))
        self.gridLayout_2.addWidget(self.moveToItemBtn, 11, 0, 1, 1)
        self.updateItemLocationBtn = QtGui.QPushButton(self.gridFrame1)
        ...
        self.gridLayout_2.addWidget(self.updateItemLocationBtn, 11, 1, 1, 1)
        self.electrode2MLIBtn = QtGui.QPushButton(self.gridFrame1)
        ...
        self.gridLayout_2.addWidget(self.electrode2MLIBtn, 7, 1, 1, 1)
        self.electrode1MLIBtn = QtGui.QPushButton(self.gridFrame1)
        ...
        self.gridLayout_2.addWidget(self.electrode1MLIBtn, 7, 0, 1, 1)
        self.electrode1PCBtn = QtGui.QPushButton(self.gridFrame1)
        self.electrode1PCBtn.setMaximumSize(QtCore.QSize(16777215, 24))
        self.electrode1PCBtn.setObjectName(_fromUtf8("electrode1PCBtn"))
        self.gridLayout_2.addWidget(self.electrode1PCBtn, 8, 0, 1, 1)
        self.electrode2PCBtn = QtGui.QPushButton(self.gridFrame1)
        self.electrode2PCBtn.setMaximumSize(QtCore.QSize(16777215, 24))
        self.electrode2PCBtn.setObjectName(_fromUtf8("electrode2PCBtn"))
        self.gridLayout_2.addWidget(self.electrode2PCBtn, 8, 1, 1, 1)
        self.cellListTable = QtGui.QTableWidget(self.gridFrame1)
        ...
        self.gridLayout_2.addWidget(self.cellListTable, 10, 0, 1, 2)
        self.label_25 = QtGui.QLabel(self.gridFrame1)
...
""))
        ...
        self.saveLocationsBtn = QtGui.QPushButton(self.gridFrame1)
        ...
        self.gridLayout_2.addWidget(self.saveLocationsBtn, 13, 0, 1, 1)
        self.loadLocationsBtn = QtGui.QPushButton(self.gridFrame1)
        ...
        self.gridLayout_2.addWidget(self.loadLocationsBtn, 13, 1, 1, 1)
        self.updateHomeLocationBtn = QtGui.QPushButton(self.gridFrame1)
        self.updateHomeLocationBtn.setObjectName(_fromUtf8("updateHomeLocationBtn"))
        self.gridLayout_2.addWidget(self.updateHomeLocationBtn, 1, 1, 1, 1)
        self.homeLocationsTable = QtGui.QTableWidget(self.gridFrame1)
        ...
        self.gridLayout_2.addWidget(self.homeLocationsTable, 3, 0, 1, 2)
        self.line = QtGui.QFrame(self.gridFrame1)
        self.line.setFrameShape(QtGui.QFrame.HLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName(_fromUtf8("line"))
        self.gridLayout_2.addWidget(self.line, 6, 0, 1, 2)
        self.removeHomeLocationBtn = QtGui.QPushButton(self.gridFrame1)
        self.removeHomeLocationBtn.setObjectName(_fromUtf8("removeHomeLocationBtn"))
        self.gridLayout_2.addWidget(self.removeHomeLocationBtn, 5, 1, 1, 1)
        ...
        self.dockWidget.setMinimumSize(QtCore.QSize(52, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.dockWidget.setFont(font)
        self.dockWidget.setStyleSheet(_fromUtf8("border-top-color: rgb(0, 0, 255);\n"
...
""))
        ...
        self.gridWidget.setGeometry(QtCore.QRect(9, 0, 521, 181))
        ...
        self.SM5Dev1PowerBtn = QtGui.QPushButton(self.gridWidget)
        ...
        self.gridLayout_4.addWidget(self.SM5Dev1PowerBtn, 2, 1, 1, 1)
        self.label_7 = QtGui.QLabel(self.gridWidget)
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.gridLayout_4.addWidget(self.label_7, 4, 0, 1, 1)
        self.connectBtn = QtGui.QPushButton(self.gridWidget)
        ...
        self.gridLayout_4.addWidget(self.connectBtn, 1, 0, 1, 2)
        self.SM5Dev2PowerBtn = QtGui.QPushButton(self.gridWidget)
        ...
        self.gridLayout_4.addWidget(self.SM5Dev2PowerBtn, 3, 1, 1, 1)
        ...
        self.C843XYPowerBtn = QtGui.QPushButton(self.gridWidget)
        ...
        self.gridLayout_4.addWidget(self.C843XYPowerBtn, 2, 0, 1, 1)
        self.C843ZPowerBtn = QtGui.QPushButton(self.gridWidget)
        ...
        self.gridLayout_4.addWidget(self.C843ZPowerBtn, 3, 0, 1, 1)
        self.refLocationBtn = QtGui.QPushButton(self.gridWidget)
        self.refLocationBtn.setMaximumSize(QtCore.QSize(16777215, 24))
        self.refLocationBtn.setObjectName(_fromUtf8("refLocationBtn"))
        self.gridLayout_4.addWidget(self.refLocationBtn, 5, 0, 1, 1)
        self.refNegativeBtn = QtGui.QPushButton(self.gridWidget)
        self.refNegativeBtn.setMaximumSize(QtCore.QSize(16777215, 24))
        self.refNegativeBtn.setObjectName(_fromUtf8("refNegativeBtn"))
        self.gridLayout_4.addWidget(self.refNegativeBtn, 5, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.recordHomeLocationBtn.setText(_translate("MainWindow", "Record Home Location", None))
        self.moveToHomeLocationBtn.setText(_translate("MainWindow", "Move to Home Location", None))
        ...
        self.updateHomeLocationBtn.setText(_translate("MainWindow", "Update Home Location", None))
